...
class DataGrid extends Nette\Application\UI\Control
{
	...
	public function setTreeView($get_children_callback, $tree_view_has_children_column = 'has_children')
	{
        ...
        /**
         * Setting tree view with paginator
         * @param type $get_children_callback
         * @param type $tree_view_has_children_column
         * @return $this
         * @throws DataGridException
         */
        public function setHugeTreeView($get_children_callback, $tree_view_has_children_column = 'has_children') {
		 ...
		 * Set tree view template file
		 */
                $this->setTemplateFile(__DIR__ . '/templates/datagrid_huge_tree.latte');

                /**
                 * So far only outer filter rendering will be possible
                 */
                $this->outer_filter_rendering = TRUE;
	...
	public function filterSucceeded(Form $form)
	{
        ...
        $this->redrawControl("resetfiltersnippet");
                /*
                 * If per page submit button was used we have to + redraw all items
                 *
                 */
                if (isset($form['per_page_submit'])) {
                    $this->reload(["allItemsWrapper"]);
                } else {
                    $this->reload();
                }
	}
	...
	{
        // filters should not be aplied for childrens
        $this->filters = [];
		...
		if ($this->getPresenter()->isAjax()) {
			...
			$this->redrawControl('items');
                        /**
                         * This is necessary only in datagrid huge tree
                         */
